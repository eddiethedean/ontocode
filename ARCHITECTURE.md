...
**v0.18 ships today:** OntoCode (VS Code), OntoCore (CLI/LSP/library), Turtle + OBO write-back, Protégé Desktop parity gate (reasoner lifecycle + cancel, stale explanations, layout reopen-with-context), plugin host, semantic diff, Ontologos reasoning.
