...
**Current release: v0.25.0** · [What ships today](https://ontocode-vs.readthedocs.io/en/latest/SHIPPED/) · [Changelog](CHANGELOG.md) · [Docs](https://ontocode-vs.readthedocs.io/en/latest/)
...
| **CLI (macOS/Windows)** | `cargo install ontocore-cli --locked --version 0.25.0` (Rust 1.88+; 15–30+ min cold) — [Install CLI](https://ontocode-vs.readthedocs.io/en/latest/guides/install-cli/) |
...
**v0.25.0** ships UX completion + verification: graph visualization parity, Plugin SDK 1.0, accessibility for OntoCode-owned webviews, and parity CI release gates. See [SHIPPED](https://ontocode-vs.readthedocs.io/en/latest/SHIPPED/), [v0.25 migration](docs/migration/v0.25.md).
