...
|------|----------|---------|
| [lsp-api.md](lsp-api.md) | Extension / LSP integrators | **Shipped v0.3** LSP methods and wire format |
| [sql-reference.md](sql-reference.md) | CLI / query users | **Shipped v0.3** virtual SQL tables |
...
- **Trust for v0.3 behavior:** `docs/lsp-api.md`, `docs/sql-reference.md`, crate `lib.rs` module docs, and tests.
