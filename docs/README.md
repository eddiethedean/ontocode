...
|------|----------|---------|
| [lsp-api.md](lsp-api.md) | Extension / LSP integrators | **Shipped v0.2** LSP methods and wire format |
| [sql-reference.md](sql-reference.md) | CLI / query users | **Shipped v0.2** virtual SQL tables |
