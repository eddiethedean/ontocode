...
| ADR | Title | Status |
|-----|-------|--------|
| [0001](0001-ontoui-shared-react-platform.md) | OntoUI as shared React platform | Accepted (partial — v0.12 panels) |
| [0002](0002-workspace-over-panel-model.md) | Workspace model over panel model | Accepted (planned v0.13) |
| [0003](0003-current-focus-central-ux.md) | Current Focus as central UX concept | Accepted (planned v0.13) |
| [0004](0004-workspacestore-ui-source-of-truth.md) | WorkspaceStore as UI source of truth | Accepted (planned v0.13) |
