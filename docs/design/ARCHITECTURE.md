...
>
> **Shipped v0.14:** plugin host MVP. **Shipped v0.15 (partial):** plugin permissions, UI views, explanation alternatives. **Planned v1.0:** full workflow plugin integration, OWL/XML write-back, full DL axiom catalog for all formats. See [Platform roadmap](../roadmap.md).
>
