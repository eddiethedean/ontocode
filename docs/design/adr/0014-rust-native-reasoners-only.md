...
Full **OWL 2 DL** classification, consistency, and unsatisfiability explanations are provided by **[OntoLogos](https://github.com/eddiethedean/ontologos)** `ontologos-dl` (1.0.0 workspace, HermiT parity in progress), integrated via `ontoindex-reasoner` per [ADR-0015](0015-adopt-ontologos-reasoner.md).
