...
Samples use the repo [`fixtures/`](https://github.com/eddiethedean/ontocode/tree/v0.26.1/fixtures) corpus. Flags: `--workspace`, `--profile`, `--mode`, `--format` only — [CLI reference](../cli-reference.md).
