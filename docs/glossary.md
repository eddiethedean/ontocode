...
|------|------------|--------|
| **OntoCore** | Rust semantic workspace engine — indexing, queries, diagnostics, reasoning integration, refactoring, CLI, LSP, plugin host | **Implemented** (v0.23) |
| **OntoCode** | VS Code extension — host shell, commands, LSP client, webview hosting | **Implemented** (v0.23) |
...
| **WorkspaceStore** | Single source of truth for OntoUI global state | **Shipped** (v0.23) |
