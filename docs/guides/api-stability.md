...
OntoCode and OntoCore are **pre-1.0**. Published crates use **0.20.x** on crates.io (latest tagged). Minor releases may add or change APIs until v1.0.0.
...
**VS Code:** install OntoCode **0.20.0** (latest tagged) from Marketplace, Open VSX, or a release VSIX — the bundled `ontocore-lsp` matches the extension version.
