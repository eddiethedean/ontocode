...
Canonical pin: **`0.24.0`** ([TAGGED_RELEASE](../TAGGED_RELEASE)). See also [Install CLI & CI (detail)](../getting-started.md) and [CI integration](../ci-integration.md) (Linux CI prefers the release tarball).
...
| Wrong version after install | Re-run with `--version 0.24.0 --locked`; check `ontocore --version` |
