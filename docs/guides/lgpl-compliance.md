...
This page helps **legal, security, and platform teams** evaluate copyleft obligations when adopting OntoCode / OntoCore **v0.11.1**. It summarizes documentation and dependency licenses — **it is not legal advice**. Engage your counsel for binding decisions.
...
| **Pin versions** | `cargo install ontocore-cli --locked --version 0.11.1` or release tarball |
