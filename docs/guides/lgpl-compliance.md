...
This page helps **legal, security, and platform teams** evaluate copyleft obligations when adopting OntoCode / OntoCore **v0.14.0**. It summarizes documentation and dependency licenses — **it is not legal advice**. Engage your counsel for binding decisions.
...
| **Pin versions** | `cargo install ontocore-cli --locked --version 0.14.0` or release tarball |
