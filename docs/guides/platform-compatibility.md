...
Supported platforms and environments for OntoCode **v0.26.0** (latest tagged). This page states **what is documented and tested in project CI** — not a formal certification.
...
Pin version: `VERSION=0.26.0` — [Install CLI & CI (detail)](../install-cli-ci.md).
