...
Supported platforms and environments for OntoCode **v0.15.0**. This page states **what is documented and tested in project CI** — not a formal certification.
...
Pin version: `VERSION=0.15.0` — [getting started](../getting-started.md).
