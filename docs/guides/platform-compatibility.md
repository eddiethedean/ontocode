...
Supported platforms and environments for OntoCode **v0.22.0** (latest tagged). This page states **what is documented and tested in project CI** — not a formal certification.
...
Pin version: `VERSION=0.22.0` — [getting started](../getting-started.md).
