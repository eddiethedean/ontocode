...
| **Latest tagged release** | **v0.25.0** — pin installs; see [Versions & channels](versions-and-channels.md) for Marketplace lag |
...
3. Pin `cargo install ontocore-cli --locked --version 0.25.0` (or current [TAGGED_RELEASE](https://github.com/eddiethedean/ontocode/blob/main/docs/TAGGED_RELEASE)) in CI.
