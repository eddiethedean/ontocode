...
3. Pin `cargo install ontocore-cli --locked --version 0.21.0` (or current [TAGGED_RELEASE](https://github.com/eddiethedean/ontocode/blob/main/docs/TAGGED_RELEASE)) in CI.
