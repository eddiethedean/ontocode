...
- Pin OntoCore **0.25.0** — `cargo install ontocore-cli --locked --version 0.25.0` or release binary with SHA256 verification — [release integrity](../release-integrity.md)
