...
- Pin OntoCore **0.10.0** — `cargo install ontocore-cli --locked --version 0.10.0` or release binary with SHA256 verification — [release integrity](../release-integrity.md)
