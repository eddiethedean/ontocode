...
- Pin OntoCore **0.26.2** — `cargo install ontocore-cli --locked --version 0.26.2` or release binary with SHA256 verification — [release integrity](../release-integrity.md)
