...
- Pin OntoCore **0.21.0** — `cargo install ontocore-cli --locked --version 0.21.0` or release binary with SHA256 verification — [release integrity](../release-integrity.md)
