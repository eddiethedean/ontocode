...
Guide for teams using Protégé today and evaluating OntoCode **v0.23**. A [first-week migration guide](protege-migration.md) ships today. RDF/XML and OWL/XML write-back **shipped in v0.21** (semantic re-serialize, not byte-identical); v0.22 completes OWL 2 authoring depth; **v0.23** adds realization, instance checking, and SWRL — see [OWL/XML write-back](owl-xml-workflow.md), [What ships today](../SHIPPED.md), and [roadmap](../roadmap.md).
