...
Use this page to decide **when OntoCode fits**, **when to keep Protégé**, and **when to run both**. It reflects **v0.9.0** — see [What ships today](../SHIPPED.md). A full Protégé migration guide is planned for **v1.0**.
...
1. Pin `ontocore-cli` **0.9.0** in Linux CI
