...
Use this page to decide **when OntoCode fits**, **when to keep Protégé**, and **when to run both**. It reflects **v0.8.0** — see [What ships today](../SHIPPED.md). A full Protégé migration guide is planned for **v1.0**.
...
Do **not** plan org-wide Protégé retirement on v0.8 documentation alone. Re-evaluate at **v1.0** against [Protégé parity matrix](../design/PROTEGE_PARITY.md).
