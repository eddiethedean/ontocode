...
This guide helps ontology teams adopt OntoCode **v0.14** alongside or instead of [Protégé](https://protege.stanford.edu/). For a capability comparison, see [Protégé vs OntoCode](protege-decision.md) and [What ships today](../SHIPPED.md).
...
```yaml
- run: cargo install ontocore-cli --locked --version 0.15.0
...
| Team expects stable plugin ecosystem API | Plugin host **MVP shipped in v0.14**; stable semver API is **v1.0** — see [Plugin authoring](plugins.md) |
