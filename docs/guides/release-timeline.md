...
|---------|--------|------------------|
| **0.24.0** | Current (tagged) | 2026-07-14 |
...
| **v0.24** | Reasoning parity + SWRL (realize, instance check, Rule Browser/Editor) | **Shipped** (2026-07-14) |
...
1. **Now (v0.24):** CI gates + controlled IDE pilot — [production readiness](production-readiness.md)
