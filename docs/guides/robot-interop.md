...
OntoCore v0.14.0 wraps the [ROBOT](http://robot.obolibrary.org/) CLI for validate, merge, and report workflows. ROBOT runs as an **external Java process** — OntoCore does not embed a JVM.
...
| **OntoCore 0.14.0+** | `ontocore robot` subcommand or LSP `ontocore/runRobot` |
