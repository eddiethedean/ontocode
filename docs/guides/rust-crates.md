...
**Install pinning:** `cargo install ontocore-cli --locked` tracks the latest compatible crates.io release. For reproducible CI or audits, pin the patch: `cargo install ontocore-cli --locked --version 0.15.0`. See [API stability](api-stability.md) and [Rust API reference](../ontocore/rust-api.md).
