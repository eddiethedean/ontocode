...
Primary dependency: `ontocore = "0.13"`. Pin an exact patch in CI: `cargo install ontocore-cli --locked --version 0.13.0`. See [Rust API reference](../ontocore/rust-api.md).
