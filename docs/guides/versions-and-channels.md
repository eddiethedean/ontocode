...
|--------|----------------|
| [`docs/TAGGED_RELEASE`](https://github.com/eddiethedean/ontocode/blob/main/docs/TAGGED_RELEASE) | Canonical public install version (today: **0.21.0**) |
...
| Goal | Command / link |
|------|----------------|
| VS Code | Marketplace **or** download `ontocode-v0.21.0.vsix` from [GitHub Releases](https://github.com/eddiethedean/ontocode/releases/tag/v0.21.0) |
| Cursor | [Open VSX](https://open-vsx.org/extension/ontocode/ontocode) or the same VSIX |
| CLI (pinned) | `cargo install ontocore-cli --locked --version 0.21.0` |
| CLI (Linux, no compile) | `ontocore-v0.21.0-x86_64-unknown-linux-gnu.tar.gz` from GitHub Releases |
