...
| Validate, query, or classify ontologies in CI | `cargo install ontocore-cli --locked --version 0.16.0` | [Getting started](../getting-started.md) · [CI integration](../ci-integration.md) |
