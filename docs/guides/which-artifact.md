...
| Validate, query, or classify ontologies in CI | **Linux x64:** release tarball from [Releases](https://github.com/eddiethedean/ontocode/releases) (preferred). **macOS / Windows / other:** `cargo install ontocore-cli --locked --version 0.25.0` | [CI integration](../ci-integration.md) · [Install](../install.md) · [Install CLI & CI (detail)](../install-cli-ci.md) |
