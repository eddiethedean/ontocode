...
| Validate, query, or classify ontologies in CI | `cargo install ontocore-cli --locked --version 0.20.0` | [Getting started](../getting-started.md) · [CI integration](../ci-integration.md) |
| Embed indexing/query in a Rust application | `ontocore = "0.20"` in `Cargo.toml` | [Rust library guide](rust-library.md) |
