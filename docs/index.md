...
<div class="oc-hero-badges">
  <span class="oc-badge oc-badge--accent">Latest tagged v0.23.0</span>
...
<p class="oc-hero-subcta"><a href="SHIPPED/">What ships today</a> · <a href="guides/versions-and-channels/">Versions &amp; channels</a> · <a href="known-limitations/">Known limitations</a> · Latest tagged: <strong>v0.23.0</strong></p>
...
**Latest tagged: v0.23.0.** Full capability matrix: **[What ships today](SHIPPED.md)**. For channel lag (Marketplace vs crates.io vs docs), see [Versions & channels](guides/versions-and-channels.md).
...
=== "CLI (Linux x64)"
    ...
    Prefer the [release tarball](https://github.com/eddiethedean/ontocode/releases/tag/v0.23.0) — verify `SHA256SUMS`, then:
