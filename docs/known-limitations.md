...
> **Current release:** v0.20.0 — see [What ships today](SHIPPED.md). **Not a full Protégé replacement today** — coexistence and pilot workflows are the supported path until **1.0**.
