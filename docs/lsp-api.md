...
> **Status:** Documents behavior in **OntoCore v0.26.1**. Pre-1.0 APIs may change.
...
- **LSP JSON Schema:** [`lsp-protocol.schema.json`](lsp-protocol.schema.json) (ships with product **v0.26.1**)
...
- Pin OntoCore to **0.26.1** in your tooling.
