...
v0.18.1 is a **patch** on the Protégé Desktop parity gate: reasoner unsatisfiable reporting, composed explanations, and test-suite hardening. See [CHANGELOG](https://github.com/eddiethedean/ontocode/blob/main/CHANGELOG.md) and the v0.18 overview in [migration/v0.18.md](v0.18.md).
