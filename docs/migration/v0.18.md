...
Scope: [v0.18_SCOPE.md](../design/v0.18_SCOPE.md) · Assessment: [ONTOCODE_0.18_PROTEGE_PARITY_ASSESSMENT.md on GitHub](https://github.com/eddiethedean/ontocode/blob/main/docs/PROTEGE_REVERSE_ENGINEERING/ONTOCODE_PARITY/ONTOCODE_0.18_PROTEGE_PARITY_ASSESSMENT.md).
...
1. Update CI pins: `cargo install ontocore-cli --locked --version 0.18.2` (or stay on an earlier `0.18.x` until you take the latest [patch notes](v0.18.2.md)).
2. Re-read [known-limitations](../known-limitations.md) — OWL/XML write-back and semantic undo remain v1.0.
