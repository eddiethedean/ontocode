...
- New Inspector sections: HasKey, DisjointUnion, Inverse, Same/Different, Negative object property assertions
- Manchester accepts `not`, `value`, `Self`, `{…}`, and xsd-driven data restrictions
- `create_entity` supports `kind: "datatype"`
- XML (RDF/XML / OWL/XML) write-back accepts the expanded op catalog (prefixes remain Turtle-only)
...
Full tables: [patch-reference](../patch-reference.md) · [OWL2_AUTHORING_GAPS](https://github.com/eddiethedean/ontocode/blob/main/docs/protege-parity/06_SUBSYSTEMS/OWL2_AUTHORING_GAPS.md)
...
1. Bump OntoCode extension and `ontocore` CLI to **0.22.0**
...
- Changelog: [0.22.0](https://github.com/eddiethedean/ontocode/blob/main/CHANGELOG.md)
- Parity: `PAR-OWL-001` / [#248](https://github.com/eddiethedean/ontocode/issues/248)
