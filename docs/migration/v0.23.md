...
- New **Rule Browser** / **Rule Editor** commands for SWRL rules stored as `ontocore:swrlRule` JSON on the ontology
...
- DL Query and SWRL-aware refactor remain **v0.24**
...
- Issues [#250](https://github.com/eddiethedean/ontocode/issues/250), [#251](https://github.com/eddiethedean/ontocode/issues/251)
