...
1. Bump OntoCode extension and `ontocore` CLI to **0.25.0**
...
- [ACCESSIBILITY_REPORT](https://github.com/eddiethedean/ontocode/blob/main/docs/protege-parity/08_RELEASE/ACCESSIBILITY_REPORT.md) (GitHub; excluded from public MkDocs)
