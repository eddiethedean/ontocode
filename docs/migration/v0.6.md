...
| Crate | `ontocore-reasoner` published to crates.io |
...
2. Update CLI: `cargo install ontocore-cli --locked --force` or download release binary.
3. Optional: add `ontocore classify --profile el` to CI after `validate`.
