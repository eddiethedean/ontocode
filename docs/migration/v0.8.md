...
- New crate: **`ontocore-refactor`**
- New CLI: `ontocore refactor usages|rename|migrate-namespace|move|extract`
- Patch ops: `add_disjoint_class`, `remove_disjoint_class`
- Pin CI: `cargo install ontocore-cli --locked --version 0.8.0` or release `VERSION=0.8.0`.
