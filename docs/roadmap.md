...
**Already shipped (v0.5–v0.13):** entity editor MVP, query workbench, graph canvas, reasoner panel, refactoring preview, semantic diff, WorkspaceStore + focus relay, schema browser — see [ROADMAP_MAPPING.md](ui/ROADMAP_MAPPING.md).
