# SPARQL reference (OntoCore v0.9)
...
**Source of truth:** [`sparql.rs` on GitHub](https://github.com/eddiethedean/ontocode/blob/main/crates/ontoindex-query/src/sparql.rs) (Oxigraph SPARQL engine).
...
- SQL virtual tables are separate — use `ontoindex query` for catalog tables like `classes`
