...
1. Open [GitHub Releases](https://github.com/eddiethedean/ontocode/releases) and download the latest `ontocode-v*.vsix` (example: `ontocode-v0.26.2.vsix`).
...
1. Download `ontocode-v*.vsix` (example: `ontocode-v0.26.2.vsix`) from [GitHub Releases](https://github.com/eddiethedean/ontocode/releases).
